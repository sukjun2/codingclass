const cssProperty = [
    ...
    { num: 12, name: "animation-num", desc: "애니메이션 keyframe 이름을 설정합니다." },
    ...
    { num: 158, name: "gap", desc: "정과 열 사이의 거리를 설정 합니다." },
...
const searchAudioPlay = document.querySelector(".play_search");
const searchAudioPause = document.querySelector(".stop_search");
...
const GameToggle = document.querySelector(".icon3");
const GameWrap = document.querySelector(".search__wrap");
...
function endQuiz() {
    ...
    searchResult.innerHTML = `당신은 ${cssProperty.length}개중에 ${count}개를 맞추었습니다.<br>당신의 점수는 ${point}점 입니다.`;
}
