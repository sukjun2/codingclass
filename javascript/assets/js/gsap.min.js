...
!(function (t, e) {
        ...
        return (
            ...
            function (t, e, r) {
                ...
                if (!d) {
                    ...
                    for (d = y[c] = [], i = T ? Math.min(f, c) * w - 0.5 : m % f, n = f === N ? 0 : T ? (c * x) / f - 0.5 : (m / f) | 0, l = N, u = h = 0; u < c; u++) (a = (u % f) - i), (s = n - ((u / f) | 0)), (d[u] = o = b ? Math.abs("y" === b ? s : a) : H(a * a + s * s)), h < o && (h = o), o < l && (l = o);
    ...
    function yb(e, r, i) {
        ...
        return (
            r &&
                !d &&
                ((n = p[0] / Ct), (a = p[1] / Ct), (s = p[2] / Ct), (h = ((l = Math.max(n, a, s)) + (f = Math.min(n, a, s))) / 2), l === f ? (o = u = 0) : ((c = l - f), (u = 0.5 < h ? c / (2 - l - f) : c / (l + f)), (o = l === n ? (a - s) / c + (a < s ? 6 : 0) : l === a ? (s - n) / c + 2 : (n - a) / c + 4), (o *= 60)), (p[0] = ~~(o + 0.5)), (p[1] = ~~(100 * u + 0.5)), (p[2] = ~~(100 * h + 0.5))),
            i && p.length < 4 && (p[3] = 1),
            p
        );
    }
        ...
        Vt =
            ...
            (Xt.paused = function paused(t) {
                return arguments.length
                    ? (this._ps !== t && ((this._ps = t) ? ((this._pTime = this._tTime || Math.max(-this._delay, this.rawTime())), (this._ts = this._act = 0)) : (Rt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== q && (this._tTime -= q)))), this)
                    : this._ps;
            }),
                ...
                if ((this !== B && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
                    ...
                    this._onUpdate && !e && Pt(this, "onUpdate", !0),
                        ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
                            ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) || this._lock || ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ya(this, 1), e || (t < 0 && !_) || (!v && !_ && m) || (Pt(this, v === m && 0 <= t ? "onComplete" : "onReverseComplete", !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
                }
                return this;
            }),
                    ...
                    ? (d || e in t || Q(e, n),
                      function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                          ...
                          for (_.b = r, _.e = i, r += "", (d = ~(i += "").indexOf("random(")) && (i = nb(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i)); )
                              (l = o[0]), (f = i.substring(m, o.index)), h ? (h = (h + 1) % 5) : "rgba(" === f.substr(-5) && (h = 1), l !== u[g++] && ((c = parseFloat(u[g - 1]) || 0), (_._pt = { _next: _._pt, p: f || 1 === g ? f : ",", s: c, c: "=" === l.charAt(1) ? ja(c, l) - c : parseFloat(l) - c, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
        ...
        jt = function _initTween(t, e) {
            ...
            if ((!E || (k && m) || (m = "none"), (t._ease = Lt(m, U.ease)), (t._yEase = O ? Bt(Lt(!0 === O ? m : O, U.ease)) : 0), O && t._yoyo && !t._repeat && ((O = t._yEase), (t._yEase = t._ease), (t._ease = O)), (t._from = !E && !!_.runBackwards), !E || (k && !_.stagger))) {
                if (((d = (h = A[0] ? ea(A[0]).harness : 0) && _[h.prop]), (r = ta(_, lt)), S && (e < 0 && M && v && !P ? S.render(-1, !0) : S.revert(M && C ? ht : ut), (S._lazy = 0)), g)) {
                    if ((ya((t._startAt = $t.set(A, pa({ data: "isStart", overwrite: !1, parent: D, immediateRender: !0, lazy: w(y), startAt: null, delay: 0, onUpdate: T, onUpdateParams: b, callbackScope: x, stagger: 0 }, g)))), e < 0 && (I || (!v && !P)) && t._startAt.revert(ht), v && C && e <= 0)) return void (e && (t._zTime = e));
                } else if (M && C && !S)
                ...
                if (p) {
                    if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _)) {
                        ...
                        (l && l.render(t < 0 ? t : !i && u ? -q : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
                            ...
                            (m !== this._tDur && m) || this._tTime !== m || (_ && !this._onUpdate && Ba(this, t, 0, !0), (!t && p) || !((m === this._tDur && 0 < this._ts) || (!m && this._ts < 0)) || ya(this, 1), e || (_ && !c) || (!m && !c) || (Pt(this, m === d ? "onComplete" : "onReverseComplete", !0), !this._prom || (m < d && 0 < this.timeScale()) || this._prom()));
                    }
                } else
    ...
    function Pd() {
        (function _windowExists() {
            ...
            window.document &&
            ((Se = window), (Ae = Se.document), (De = Ae.documentElement), (Re = Ld("div") || { style: {} }), Ld("div"), (hr = cr(hr)), (lr = hr + "Origin"), (Re.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0"), (Ie = !!cr("perspective")), (Fe = Ce.core.reverting), (ze = 1));
    }
    function Qd(t) {
        var e,
              ...
              (!_ && "%" !== h) || (!er[e] && !~e.indexOf("adius"))
                  ? ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
                    ...
                    (s = a._gsap) && _ && s.width && f && s.time === zt.time && !s.uncache
                        ? ha((u / s.width) * 100)
                        : ((!_ && "%" !== h) || pr[Md(a, "display")] || (l.position = Md(t, "position")), a === t && (l.position = "static"), a.appendChild(Re), (n = Re[d]), a.removeChild(Re), (l.position = "absolute"), f && _ && (((s = ea(a)).time = zt.time), (s.width = a[d])), ha(p ? (n * u) / 100 : n && u ? (100 / n) * u : 0)))
    ...
    function he(t, e) {
        ...
        return s.svg && t.getAttribute("transform")
            ? "1,0,0,1,0,0" === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",")
                ? vr
                : u
            : (u !== vr || t.offsetParent || t === De || s.svg || ((n = o.display), (o.display = "block"), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), De.appendChild(t)), (u = ge(t)), n ? (o.display = n) : Ud(t, "display"), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : De.removeChild(t))),
    ...
    function ie(t, e, r, i, n, a) {
        var s,
            ...
            w = parseFloat(b[0]) || 0,
            x = parseFloat(b[1]) || 0;
        r ? l !== vr && (o = _ * v - m * g) && ((u = w * (-m / o) + x * (_ / o) - (_ * T - m * y) / o), (w = w * (v / o) + x * (-g / o) + (g * T - v * y) / o), (x = u)) : ((w = (s = Sd(t)).x + (~b[0].indexOf("%") ? (w / 100) * s.width : w)), (x = s.y + (~(b[1] || b[0]).indexOf("%") ? (x / 100) * s.height : x))),
    ...
    var Se,
        ...
        _r = function _get(t, e, r, i) {
            ...
            return (
                ...
                er[e] && "transform" !== e ? ((n = Tr(t, i)), (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : br(Md(t, lr)) + " " + n.zOrigin + "px")) : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) || (n = (gr[e] && gr[e](t, e, r)) || Md(t, e) || fa(t, e) || ("opacity" === e ? 1 : 0)),
        ...
        Tr = function _parseTransform(t, e) {
            ...
            return (
                ...
                (r.svg = !(!t.getCTM || !Td(t))),
                L.translate &&
                    (("none" === L.translate && "none" === L.scale && "none" === L.rotate) || (F[hr] = ("none" !== L.translate ? "translate3d(" + (L.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + ("none" !== L.rotate ? "rotate(" + L.rotate + ") " : "") + ("none" !== L.scale ? "scale(" + L.scale.split(" ").join(",") + ") " : "") + L[hr]),
        ...
        Pr = function _renderSVGTransforms(t, e) {
            ...
            (c = parseFloat(c)),
                ...
                c || d ? ((c *= ir), (d *= ir), (r = Math.cos(c) * _), (i = Math.sin(c) * _), (n = Math.sin(c - d) * -m), (a = Math.cos(c - d) * m), d && ((p *= ir), (s = Math.tan(d - p)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), p && ((s = Math.tan(p)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))), (r = ha(r)), (i = ha(i)), (n = ha(n)), (a = ha(a))) : ((r = _), (a = m), (i = n = 0)),
                    ...
                    if ("autoRound" !== c && ((o = e[c]), !dt[c] || !$b(c, e, i, n, t, a)))
                        if (((l = typeof o), (f = gr[c]), "function" === l && (l = typeof (o = o.call(i, n, t, a))), "string" === l && ~o.indexOf("random(") && (o = nb(o)), f)) f(this, t, c, o, i) && (T = 1);
                            ...
                            if (
                                ...
                                (u = parseFloat(o)),
                                c in ur && ("autoAlpha" === c && (1 === h && "hidden" === _r(t, "visibility") && u && (h = 0), b.push("visibility", x.visibility), Vd(this, x, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), "scale" !== c && "transform" !== c && ~(c = ur[c]).indexOf(",") && (c = c.split(",")[0])),
                                (m = c in er))
                            )
                            ...
                            if (m || ((u || 0 === u) && (h || 0 === h) && !or.test(o) && c in x))
                                (u = u || 0), (d = (s + "").substr((h + "").length)) !== (p = Xa(o) || (c in V.units ? V.units[c] : d)) && (h = Yd(t, c, s, p)), (this._pt = new me(this._pt, m ? v : x, c, h, (_ ? ja(h, _ + u) : u) - h, m || ("px" !== p && "zIndex" !== c) || !1 === e.autoRound ? sd : vd)), (this._pt.u = p || 0), d !== p && "%" !== p && ((this._pt.b = s), (this._pt.r = ud));
