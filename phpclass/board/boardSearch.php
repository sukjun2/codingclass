            ...
            <div class="board__inner">
                <div class="board__title">
                    ...
                    <?php
                        ...
                        //     $countSql = "SELECT b.boardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID) ";
                        //     switch($searchOption){
                        //         case 'title':
                        //             $countSql .= "WHERE b.boardTitle LIKE '%$searchKeyword%' ORDER BY boardID DESC ";
                        //             break;
                        //         case 'content':
                        //             $countSql .= "WHERE b.boardContents LIKE '%$searchKeyword%' ORDER BY boardID DESC ";
                        //             break;
                        //         case 'name':
                        //             $countSql .= "WHERE m.youName LIKE '%$searchKeyword%' ORDER BY boardID DESC ";
                        //             break;
                        //     }
                        ...
                        //     // $sql = "SELECT b.boardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID) WHERE b.boardTitle LIKE '%$searchKeyword%' ORDER BY boardID DESC LIMIT 10";
                        //     // $sql = "SELECT b.boardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID) WHERE b.boardContents LIKE '%$searchKeyword%' ORDER BY boardID DESC LIMIT 10";
                        //     // $sql = "SELECT b.boardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID) WHERE m.youName LIKE '%$searchKeyword%' ORDER BY boardID DESC LIMIT 10";

                        //     $countSql .= "LIMIT {$viewLimit}, {$viewNum};";
                        //     // echo $countSql;
                        //     // $sql = "SELECT b.boardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID) ";
                        //     // switch($searchOption){
                        //     //     case 'title':
                        //     //         $sql .= "WHERE b.boardTitle LIKE '%$searchKeyword%' ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
                        //     //         break;
                        //     //     case 'content':
                        //     //         $sql .= "WHERE b.boardContents LIKE '%$searchKeyword%' ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
                        //     //         break;
                        //     //     case 'name':
